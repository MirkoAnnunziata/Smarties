...
//  SPark
//
//  Created by Giovanni Iannace on 30/01/17.
...
class AppDelegate: NSObject, UIApplicationDelegate, SKMapVersioningDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
            // inizializzo la mia api e le mappe
            let initSettings: SKMapsInitSettings = SKMapsInitSettings()
            initSettings.mapDetailLevel = .full
        
            SKMapsService.sharedInstance().initializeSKMaps(withAPIKey: "c09ef905998c72d06c31a17c87b78beebe18a22339a905ecc0cc3dd7d237d1b3", settings: initSettings)
